...
sindy_params = {
    'ac_data.npy': {
        'library': {'type': 'pde', 'poly_degree': 3, 'poly_include_bias': False, 'derivative_order': 3, 'max_orders': (2, 3), 'pde_include_bias': True},
        'optimizer': {'type': 'STLSQ', 'threshold': 1, 'alpha': 1e-5, 'normalize_columns': True, 'coefficient_tol': 1e-3}
    },
    
    'kdv_data.mat': {
        'library': {'type': 'pde', 'poly_degree': 1, 'poly_include_bias': False, 'derivative_order': 3, 'max_orders': (1, 3), 'pde_include_bias': True},
        'optimizer': {'type': 'STLSQ', 'threshold': 5, 'alpha': 1e-5, 'normalize_columns': True}
    },

    'kdv_periodic_data.npy': {
        'crop': 10,
        'library': {'type': 'pde', 'poly_degree': 1, 'poly_include_bias': False, 'derivative_order': 3, 'max_orders': (1, 3), 'pde_include_bias': True, 'custom_tokens': ['sin(x)', 'cos(t)', 'sin(x) cos(t)', 'cos(x) sin(t)']},
    ...
    'pde_divide_data.npy': {
        'crop': 10,
        'library': {'type': 'pde_custom_concat', 'poly_degree': 1, 'poly_include_bias': False, 'derivative_order': 3, 'max_orders': (2, 3), 'pde_include_bias': True, 'coordinate_variables': ['x'], 'custom_tokens': ['(1/x) u', '(1/x) u_x']},
        'optimizer': {'type': 'STLSQ', 'threshold': 0.01, 'alpha': 1e-10, 'normalize_columns': False}
    },

    'pde_compound_data.npy': {
        'crop': 10,
        'library': {'type': 'pde_custom_concat', 'poly_degree': 1, 'poly_include_bias': False, 'derivative_order': 3, 'max_orders': (2, 3), 'pde_include_bias': True, 'custom_tokens': ['d_x(u u_x)']},
        'optimizer': {'type': 'STLSQ', 'threshold': 0.02, 'alpha': 1e-10, 'normalize_columns': False, 'coefficient_tol': 1e-3}
    },

    'ks_data.mat': {
        'crop': 5,
        'library': {'type': 'pde', 'poly_degree': 1, 'poly_include_bias': False, 'derivative_order': 4, 'max_orders': (1, 4), 'pde_include_bias': True, 'diff_kwargs': {'periodic': True}},
    ...
    'wave_data.csv': {
        ...
        'library': {'type': 'pde', 'poly_degree': 3, 'poly_include_bias': True, 'derivative_order': {'x': 3, 't': 1}, 'max_orders': (2, 3), 'derivative_axes': ['x', 't'], 'pde_include_bias': True},
        'optimizer': {'type': 'STLSQ', 'threshold': 0.01, 'alpha': 1e-10, 'normalize_columns': False}
    },

    'lorenz_data.npy': {
        'library': {'type': 'polynomial', 'degree': 2, 'include_bias': True, 'max_orders': (1,), 'variable_names': ['x0', 'x1', 'x2'], 'polynomial_variables': ['x0', 'x1', 'x2']},
        'optimizer': {'type': 'STLSQ', 'threshold': 0.1, 'alpha': 0.05, 'normalize_columns': False}
    },

    'lotka_data.npy': {
        'library': {'type': 'polynomial', 'degree': 2, 'include_bias': False, 'max_orders': (1,), 'variable_names': ['x0', 'x1'], 'polynomial_variables': ['x0', 'x1']},
        'optimizer': {'type': 'STLSQ', 'threshold': 0.5, 'alpha': 0.05, 'normalize_columns': False}
    },

    'vdp_data.npy': {
        'targets': [{'name': 'u_tt', 'variable': 'u', 'axis': 't', 'order': 2}],
        'library': {'type': 'polynomial', 'degree': 2, 'include_bias': True, 'derivative_order': 1, 'max_orders': (2, 2), 'derivative_axes': ['t']},
    ...
    'ode_data.npy': {
        'crop': 10,
        'targets': [{'name': 'u_tt', 'variable': 'u', 'axis': 't', 'order': 2}],
        'library': {'type': 'polynomial', 'degree': 1, 'include_bias': True, 'derivative_order': 1, 'max_orders': (2, 2), 'derivative_axes': ['t'], 'custom_tokens': ['t', 'u_t sin(2 t)']},
    ...
    'ns_data.mat': {
        ...
        'library': {
            ...
            'max_orders': (1, 2, 2),
            'variable_names': ['u', 'v', 'p'],
            'ns_velocity_poly_degree': 1,
            'ns_derivative_order': 2,
        },
    ...
    'ODE_simple_discovery': {
        ...
        'library': {'type': 'poly_and_fourier', 'poly_degree': 3, 'poly_include_bias': True, 'n_frequencies': 1, 'max_orders': (2, 3), 'derivative_order': 0, 'custom_tokens': ['sin(t)', 'cos(t)']},
