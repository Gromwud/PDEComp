...
sindy_params = {
    ...
    'lorenz_data.npy': {
        'library': {'type': 'polynomial', 'data_fun_pow': 1, 'equation_factors_max_number': 2, 'include_bias': True, 'max_deriv_order': (1,), 'variable_names': ['x0', 'x1', 'x2'], 'polynomial_variables': ['x0', 'x1', 'x2']},
        'optimizer': {'type': 'STLSQ', 'threshold': 0.1, 'alpha': 0.05, 'normalize_columns': False}
    },

    'lotka_data.npy': {
        'library': {'type': 'polynomial', 'data_fun_pow': 1, 'equation_factors_max_number': 2, 'include_bias': False, 'max_deriv_order': (1,), 'variable_names': ['x0', 'x1'], 'polynomial_variables': ['x0', 'x1']},
    ...
    'ODE_simple_discovery': {
        ...
        'library': {'type': 'poly_and_fourier', 'data_fun_pow': 3, 'equation_factors_max_number': 2, 'poly_include_bias': True, 'n_frequencies': 1, 'max_deriv_order': (2, 3), 'custom_tokens': ['sin(t)', 'cos(t)']},
